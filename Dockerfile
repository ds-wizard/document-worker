...
RUN apt-get update && apt-get install -qq -y wget libpq-dev gcc build-essential python3-dev python3-pip python3-setuptools python3-wheel python3-cffi libcairo2 libpango-1.0-0 libpangocairo-1.0-0 libgdk-pixbuf2.0-0 libffi-dev shared-mime-info gdebi
...
RUN wget --quiet https://www.princexml.com/download/prince_14.2-1_debian10_amd64.deb && \
    gdebi prince_14.2-1_debian10_amd64.deb && \
    rm -f pandoc-2.14.1-1-amd64.deb
