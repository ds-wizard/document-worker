...
class Database:
    ...
    UPDATE_DOCUMENT_STATE = f'UPDATE document SET state = %s, worker_log = %s WHERE uuid = %s;'
    UPDATE_DOCUMENT_RETRIEVED = f'UPDATE document SET retrieved_at = %s, state = %s WHERE uuid = %s;'
    UPDATE_DOCUMENT_FINISHED = f'UPDATE document SET finished_at = %s, state = %s, ' \
                               f'file_name = %s, content_type = %s, worker_log = %s WHERE uuid = %s;'
